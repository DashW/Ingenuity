...
def main():
    ...
    if cmd == 'linux':
        ...
        VARS['$INCLUDES'] = '/I"C:\Program Files\Microsoft Visual Studio 11.0\VC\include\"'
        VARS['$LINKER'] = '/link /LIBPATH:"C:\Program Files\Microsoft Visual Studio 11.0\VC\lib\" /LIBPATH:"C:\Program Files\Windows Kits\8.0\Lib\win8\um\x86\"'
        build_vs()
    elif cmd == '64k':
        build_64k()
    elif cmd == 'blob':
...
def build_vs():
    ...
    do_cmd('cl vmmain.c /D "inline=" /Od /MD /Fdvm.pdb /Fmvm.map /Fevm.exe')

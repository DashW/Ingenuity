#line 9 "C:\\Users\\Richard\\SkyDrive\\Documents\\Gaming Projects\\FrameworkLib\\BaseShaderAdd.cgfx"
...
#line 29 "C:\\Users\\Richard\\SkyDrive\\Documents\\Gaming Projects\\FrameworkLib\\BaseShaderAdd.cgfx"
...
PixelOut pixPosNor(VertexOutPosNor vtx)
{
	...
	float brightness = (output.color.r + output.color.g + output.color.b) / 3.0f;
	output.color = float4(output.color.rgb,brightness);
	return output;
}

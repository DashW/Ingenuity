...
VertexOutPosNorTex main(in float3 _inputPos : POSITION, in float3 _inputNormal : NORMAL0, in float2 _inputTexCoord : TEXCOORD0, in float3 worldPos : COLOR0)
{
    VertexOutPosNorTex _vout;

    _vout._WorldPos1 = mul(float4(_inputPos, 1.0f), _world).xyz + worldPos;
